...
public class DockerRuleBuilder {
    ...
    /**
     * @param needPull The name of the docker image to download
     * @return The builder
     */
    public DockerRuleBuilder needsPull(boolean needPull) {
        params.needPull = needPull;
        return this;
    }
    ...
    public DockerRuleBuilder mappedPorts(String... mappedPorts) {
        params.mappedPorts = mappedPorts;
        return this;
    }
